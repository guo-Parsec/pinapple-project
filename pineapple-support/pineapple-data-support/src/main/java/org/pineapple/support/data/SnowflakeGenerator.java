...
public class SnowflakeGenerator implements IdentifierGenerator {
    ...
    public static SnowflakeGenerator getBean() {
        return SpringUtil.getBean(SnowflakeGenerator.class);
    }
    ...
    @PostConstruct
    public void init() {
        machineId = snowflakeProp.getMachineId();
        datacenterId = snowflakeProp.getDatacenterId();
    ...
    public Long nextId(Object entity) {
        return SnowflakeGenerator.getBean().nextId();
    }
}
